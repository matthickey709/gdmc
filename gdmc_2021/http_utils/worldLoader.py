...
from http_utils.bitarray import BitArray
...
class WorldSlice:
    ...
    def getChunkId(self, x, z) -> int:
        chunkX = (x >> 4) - self.chunkRect[0]
        chunkZ = (z >> 4) - self.chunkRect[1]
        return chunkX + chunkZ * self.chunkRect[2]
